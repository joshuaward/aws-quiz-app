...
const questions = [// Domain 1 – 6 questions (Exam-style)
  ...
  {id:5,domain:1,type:"single",
   ...
   options:["Deep learning requires less data than traditional ML","Deep learning automatically learns hierarchical feature representations from raw data using multi-layer neural networks, often eliminating manual feature engineering","Deep learning only works on text data","Deep learning always outperforms traditional ML on tabular data"],
   correct:[1],
  ...
  {id:7,domain:2,type:"single",
   ...
   options:["Option A — fine-tuning always provides higher accuracy","Option B — RAG allows the knowledge base to be updated weekly without retraining, ensuring the model always references current policies","Either approach is equally effective for this use case","Option A — RAG cannot handle structured policy documents"],
   correct:[1],
  ...
  {id:12,domain:2,type:"single",
   ...
   options:["Amazon Q Business is only for data analysis; Amazon Q Developer is only for writing documentation","Amazon Q Business is a generative AI assistant for enterprise employees to query company data; Amazon Q Developer is an AI coding assistant for software developers","Amazon Q Developer is more expensive than Amazon Q Business","They are identical products with different names"],
   correct:[1],
  ...
  {id:14,domain:3,type:"single",
   ...
   options:["Increase the model's temperature to generate more varied responses","Implement metadata filtering in the knowledge base to restrict retrieval to documents from the last 12 months, and include document dates in the prompt context","Add more documents to the knowledge base without filtering","Reduce the number of retrieved chunks to decrease context length"],
   correct:[1],
