...
const questions = [// Domain 1 – 6 questions (Advanced scenario-based)
  ...
  {id:9,domain:2,type:"single",
   ...
   options:["RAG produces higher-quality outputs than fine-tuning in all scenarios","RAG allows the knowledge base to be updated without retraining the model, making it better for frequently changing data","Fine-tuning is always more expensive than RAG","RAG eliminates the need for any infrastructure management"],
   correct:[1],
  ...
  {id:11,domain:2,type:"single",
   ...
   options:["The number of AWS Regions the model is available in","The model's parameter count and associated compute (energy) requirements for training and inference","The programming language used to build the application","The number of concurrent users accessing the model"],
   correct:[1],
