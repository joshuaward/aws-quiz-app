...
const questions = [ // Domain 1 – 6 questions (Intermediate)
    ...
    // Domain 4 – 4 questions (Intermediate)
    {
        ...
        options: [
            ...
            "Data drift causing model performance to degrade in a biased way",
            "The model was overfitting at deployment"
        ],
        correct: [2],
    ...
    },
    {
        ...
        options: [
            "Requiring too much labeled training data",
            "Model underfitting on training data",
            "Generating confidently wrong legal citations that do not exist (hallucination)",
            "Potential intellectual property infringement in generated legal text",
            "Slow inference compared to rule-based systems"
        ],
        correct: [2, 3],
    ...
    // Domain 5 – 4 questions (Intermediate)
    {
        ...
        options: [
            ...
            "AWS PrivateLink (VPC endpoint for Amazon Bedrock)",
