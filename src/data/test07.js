...
const questions = [{
    ...
    },
    {
        ...
        options: [
            "The model was trained on general-purpose internet data",
            "The model runs faster on larger datasets",
            "The model performs well on new, unseen data — not just the data it was trained on",
            "The model has more parameters than the baseline"
        ],
        correct: [2],
    ...
    },
    {
        ...
        options: [
            "Adjusting GPU memory allocation for model inference",
            "Training a new foundation model from scratch using custom datasets",
            "Designing, iterating, and optimizing the text inputs (prompts) provided to a foundation model to elicit the best possible outputs for a given task",
            "Modifying the model's neural network architecture"
        ],
        correct: [2],
    ...
    },
    {
        ...
        options: [
            "Amazon Bedrock Knowledge Bases eliminate the need for any foundation model",
            "Amazon Bedrock Knowledge Bases always produce better answers than custom RAG pipelines",
            "Amazon Bedrock Knowledge Bases fully manages document ingestion, chunking, embedding, vector storage, and retrieval — reducing development effort and operational overhead",
            "Amazon Bedrock Knowledge Bases work only with Amazon-proprietary document formats"
        ],
        correct: [2],
    ...
    },
    {
        ...
        options: [
            "Connecting the model to the internet for live search",
            "Running the model on dedicated GPU hardware",
            "Ensuring model responses are anchored to specific, verifiable source documents rather than relying solely on the model's parametric memory",
            "Decreasing the temperature to reduce response randomness"
        ],
        correct: [2],
    ...
    },
    {
        ...
        options: [
            "To distribute training across multiple AWS Regions",
            "To reduce the model's computational requirements",
            "To align the model's outputs with human preferences and values by training a reward model based on human ratings",
            "To automatically label training data without human involvement"
        ],
        correct: [2],
