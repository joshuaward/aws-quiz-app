...
const questions = [// Domain 1 – 6 questions (Foundational)
  ...
  {id:8,domain:2,type:"single",
   ...
   options:["Embeddings","Weights","Tokens","Vectors"],
   correct:[2],
  ...
  {id:10,domain:2,type:"single",
   ...
   options:["Transformer-based LLM","Recurrent Neural Network (RNN)","Diffusion model","Decision tree ensemble"],
   correct:[2],
  ...
  {id:26,domain:4,type:"multi",
   ...
   options:["Deploying a model without any testing to speed time to market","Conducting regular bias audits on deployed models","Documenting known limitations and failure modes of an AI system","Using the same model for all use cases to reduce development costs","Collecting personal data without user consent to improve model accuracy"],
   correct:[1,2],
